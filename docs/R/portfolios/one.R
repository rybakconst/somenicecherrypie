#### *ПАКЕТЫ* ####
#install.packages("PortfolioAnalytics", "quantmod", "PerformanceAnalytics", "zoo", "plotly")
...
for(i in 1:length(vec)){
  eff.port <- PortfolioAnalytics::add.constraint(port, type = "return", name = "mean", return_target = vec[i])
...
# Let’s also plot the weights to check how diversified our optimal portfolios are.
